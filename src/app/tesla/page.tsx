...
import Slidder from "../tesla/Slidder";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <div className="relative h-80">
              <Image
                src="https://i.ibb.co/fdK5LRf4/modely.jpg"
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <div className="relative h-80">
              <Image
                src="https://i.ibb.co/vxFkqmL1/tesla-gold-jpg.jpg"
                alt="Tesla Model 3"
                fill
                className="object-cover"
              />
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <div className="relative h-80">
              <Image
                src="https://i.ibb.co/NdQTp5Vk/tesla-roadster.jpg"
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <div className="relative h-80">
              <Image
                src="https://i.ibb.co/rKS3sxvR/tesla-m.jpg"
                alt="Tesla robotaxi"
                fill
                className="object-cover"
              />
