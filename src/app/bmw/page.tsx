...
import Slidder from "../bmw/slidder";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <div className="relative h-80  ">
              <Image
                src="https://i.ibb.co/KByB5tC/BMW-SUV.jpg"
            ...
            <div className="p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <h2 className="text-lg font-semibold">BMW-X3 M Family SUV</h2>
              ...
              <div className="flex items-center mt-1">
                ...
                <span className="text-gray-700">$65,700</span>
              </div>
          ...
          <div className=" rounded-lg overflow-hidden shadow-md">
            <div className="bg-white relative h-80">
              <Image
                src="https://i.ibb.co/wh0hmnCc/BMW-Vision.jpg"
                alt="Tesla Model 3"
                fill
                className="object-cover"
              />
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <div className="relative  h-85">
              <Image
                src="https://i.ibb.co/SDmrTqZH/BMW-M4.jpg"
            ...
            <div className="p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <h2 className="text-lg font-semibold">2025 BMW M4 Coupe</h2>
                  <span className="bg-pink-500 text-white text-xs px-2 py-0.5 rounded-full">
                    Best
                  </span>
                </div>
              ...
              <div className="flex items-center mt-1">
                <span className="font-medium mr-2">Price:</span>
                <span className="text-gray-700">$1,25,325</span>
              </div>
              <div className="flex items-center justify-between mt-3">
                <div className="flex items-center">
                  {[1, 2, 3, 4].map((i) => (
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <div className="relative h-85">
              <Image
                src="https://i.ibb.co/8q5xDJv/BMW-M.jpg"
                alt="BMW-X3 M "
                fill
                className="object-cover"
              />
            ...
            <div className="p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <h2 className="text-lg font-semibold">BMW-X3 M</h2>
                  <span className="bg-pink-500 text-white text-xs px-2 py-0.5 rounded-full">
                    Best
                  </span>
                </div>
              ...
              <div className="flex items-center mt-1">
                <span className="font-medium mr-2">Price:</span>
                <span className="text-gray-700">$87,175</span>
              </div>
              <div className="flex items-center justify-between mt-3">
                <div className="flex items-center">
                  {[1, 2, 3, 4].map((i) => (
