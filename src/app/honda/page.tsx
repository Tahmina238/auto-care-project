...
import Slidder from "../honda/Slidder";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <div className="relative h-80">
              <Image
                src="https://i.ibb.co/6J7q8cDD/honda-civic.jpg"
                alt="Honda"
                fill
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <div className="relative h-80">
              <Image
                src="https://i.ibb.co/nMXdmZ5b/honda-car.jpg"
                alt="Tesla Model 3"
                fill
                className="object-cover"
              />
            ...
            <div className="p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <h2 className="text-lg font-semibold">Tesla Model 3</h2>
                  <span className="bg-pink-500 text-white text-xs px-2 py-0.5 rounded-full">
                    Best
                  </span>
                </div>
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <div className="relative h-80">
              <Image
                src="https://i.ibb.co/VWCDZ8yS/honda.jpg"
            ...
            <div className="p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <h2 className="text-lg font-semibold">Tesla Model X Plaid</h2>
                  <span className="bg-pink-500 text-white text-xs px-2 py-0.5 rounded-full">
                    Best
                  </span>
                </div>
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <div className="relative h-80">
              <Image
                src="https://i.ibb.co/5XCkdQzC/honda-bl.jpg"
            ...
            <div className="p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <h2 className="text-lg font-semibold">Tesla Model S Plaid</h2>
                  <span className="bg-pink-500 text-white text-xs px-2 py-0.5 rounded-full">
                    Best
                  </span>
                </div>
